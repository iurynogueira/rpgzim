...
var a = { n: "Conan", c: "Guerreiro", h: 100, m: 0, w: null };
var b = { n: "Merlin", c: "Mago", h: 80, m: 100, w: null };
var xx = { n: "Legolas", c: "Arqueiro", h: 90, m: 30, w: null };
var ws = [
...
function aparecerMonstro() {
    var i = Math.floor(Math.random() * monstros.length);
    monstroAtual = __assign({}, monstros[i]);
    console.log("Um " + monstroAtual.n + " apareceu! Vida: " + monstroAtual.h);
}
function atacarMonstro(p) {
    if (!monstroAtual) {
